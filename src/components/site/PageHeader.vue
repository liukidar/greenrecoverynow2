  ...
  <div class="page-header white-text text-important">
    <div class="container">
      <tr-slide-in class="ch-tr1" stagger="400">
        <h2 v-if="loaded" :key="0" data-index="2" data-from="-100vw, 0">{{openTitleChar}} <img src="/static/imgs/logo-thin.png" style="width:128px; vertical-align:middle;"> {{openTitleChar}}</h2>
