  ...
  <div class="flex-filler grey darken-4" style="position: relative; overflow: hidden;">
    ...
    <div>
      <masonry class="row" ref="masonry" style="padding-bottom: 8rem;">
        <sourced-style :onclose="() => updateArticleMetadata(article.ID)" :prototype="style" :value="article" v-for="article in selected" :key="article.ID" class="border no-padding" :class="article.style">
